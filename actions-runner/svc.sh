...
SVC_NAME="actions.runner.sjnyos-guthubaction-test.hosting nodeapp selfhosted.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (sjnyos-guthubaction-test.hosting nodeapp selfhosted)"
